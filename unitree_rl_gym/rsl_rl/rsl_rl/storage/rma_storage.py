...
class RMAStorage(RolloutStorage):
    ...
    def _save_hidden_states(self, hidden_states):
        ...
        hid_c = hidden_states[2] if isinstance(hidden_states[2], tuple) else (hidden_states[2],)
        ...
        for ep in range(num_epochs):
            ...
            for i in range(num_mini_batches):
                ...
                yield obs_batch, critic_obs_batch, rma_obs_batch, actions_batch, values_batch, advantages_batch, returns_batch, \
                       old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, (hid_a_batch,hid_r_batch,hid_c_batch), masks_batch
